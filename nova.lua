...
if not isfolder("nova/configs") then
    makefolder("nova/configs")
end

if not isfolder("nova/configs/da_hood") then
    makefolder("nova/configs/da_hood")
end
...
local UserInterface = (function() -- src/Lua/Interface/Interface.Lua
    ...
    function UserInterface:Create(OptionsLaughtOutLouds)
        ...
        local Texts = {
            "check credits and load configs if want to!",
        }
        ...
        UI["a"]["Text"] = [[powered by https://dsc.gg/getnova]]
    ...
    local function my_script()
        ...
        if chosen_game == "da_hood" then
            (function() -- src/Lua/Scripts/da_hood/da_hood.lua
                ...
                if please_load then
                    ...
                    local Interface = UserInterface:Create{title = 'nova<font color="rgb(168, 157, 159)">.dahood</font>',}
                    ...
                    do -- src/Lua/Scripts/da_hood/components/
                        ...
                        do -- src/Lua/Scripts/da_hood/components/c_render.lua
                            ...
                            do -- indicator
                                ...
                                local title = indicatorClass:new_indicator("nova.universal")
                        ...
                        do -- src/Lua/Scripts/da_hood/components/d_misc.lua
                            ...
                            do
                                ...
                                macro_toggle:Keybind({ title = "macro*not working*", keybindlist = true, keybindname = "macro", callback = function (key)
                                    macro.keybind = key
                        ...
                        do -- src/Lua/Scripts/da_hood/components/f_settings.lua
                            ...
                            function config:get_list()
                                ...
                                if #listfiles("nova/configs/da_hood") > 0 then
                                    for i, v in next, listfiles("nova/configs/da_hood") do
                            ...
                            local NOTE = settingsTab:Section("credits", "left")
                            NOTE:Label("Zen-Dev")
                            NOTE:Label("Sco-Reviewer")
                            NOTE:Label("Azure Modded-UI Helper")
                            NOTE:Label("Fatialty-Script Helper")
        ...
        elseif chosen_game == "universal" then
            (function() 
                ...
                local Interface = UserInterface:Create{title = 'nova<font color="rgb(168, 157, 159)">.universal</font>',}
                ...
                do -- src/Lua/Scripts/universal/components/
                    ...
                    do -- src/Lua/Scripts/universal/components/b_render.lua
                        ...
                        local title = fucking_shitty_indicator:new_indicator("nova.universal")
                        aim_Ass_character.changecolor(Color3.fromRGB(255,255,255))
...
--[[
local Interface = UserInterface:Create{title = 'nova<font color="rgb(168, 157, 159)">.dev</font>',}
